...
$sql = <<<EOT
SELECT 
    ddh.dh_ma, ddh.dh_ngaylap, ddh.dh_noigiao, httt.httt_ten, kh.kh_ten, kh.kh_dienthoai
...
GROUP BY ddh.dh_ma, ddh.dh_ngaylap, ddh.dh_noigiao, httt.httt_ten, kh.kh_ten, kh.kh_dienthoai
EOT;
